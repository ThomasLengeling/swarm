...
static btn_color_t button_colors[BUTTON_COLORS_COUNT] = {
    {0x00, 0xFB, 0xCB}, {0x70, 0x80, 0x90}, {0x87, 0xCE, 0xEB},
    {0x00, 0x80, 0x00}, {0x7B, 0x68, 0xEE}, {0x46, 0x82, 0xB4},
...
static btn_pattern_t selected_button_pattern = BUTTON_PATTERN_FIRE;
